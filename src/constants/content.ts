...
export const PROJECTS: Project[] = [
  { id: 'p1', title: 'SetuPay', client: 'SetuPay Fintech', category: 'Web App', description: 'A UPI-first digital banking platform with real-time analytics and instant payments across Bharat.', tags: ['React', 'Node', 'AWS'], image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=70', accent: 'from-indigo-500 to-cyan-400', metric: { value: '3.2M', label: 'monthly users' } },
  { id: 'p2', title: 'BazaarKart', client: 'BazaarKart Retail', category: 'E-commerce', description: 'A headless D2C storefront that lifted conversions by 47% for a fast-growing homegrown brand.', tags: ['Next.js', 'Shopify', 'Hydrogen'], image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=1200&q=70', accent: 'from-violet-500 to-fuchsia-400', metric: { value: '+47%', label: 'conversion rate' } },
  { id: 'p3', title: 'Arogya', client: 'Arogya Health', category: 'Mobile App', description: 'A telemedicine app connecting patients in tier-2 and tier-3 cities with specialists in seconds.', tags: ['Flutter', 'Firebase', 'AI'], image: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1200&q=70', accent: 'from-cyan-500 to-sky-400', metric: { value: '4.9★', label: 'app store rating' } },
  { id: 'p4', title: 'VyaparCRM', client: 'Vyapar Solutions', category: 'Software', description: 'A custom CRM that unified five tools into one lightning-fast workspace for a growing sales team.', tags: ['React', 'GraphQL', 'Postgres'], image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=1200&q=70', accent: 'from-indigo-500 to-violet-400', metric: { value: '5×', label: 'faster workflows' } },
  { id: 'p5', title: 'GyaanAI', client: 'Gyaan Labs', category: 'Cloud & AI', description: 'A RAG-powered assistant resolving 90% of customer queries in Hindi and English, automatically.', tags: ['Next.js', 'LLM', 'Vector DB'], image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1200&q=70', accent: 'from-purple-500 to-indigo-400', metric: { value: '90%', label: 'auto-resolved' } },
  { id: 'p6', title: 'MeghCloud', client: 'Megh Systems', category: 'Cloud & AI', description: 'Migrated a legacy monolith to a resilient microservices platform on Kubernetes with zero downtime.', tags: ['AWS', 'K8s', 'Terraform'], image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=70', accent: 'from-sky-500 to-cyan-400', metric: { value: '99.99%', label: 'uptime' } },
];

export const PROJECT_FILTERS = ['All', 'Web App', 'E-commerce', 'Mobile App', 'Software', 'Cloud & AI'] as const;
