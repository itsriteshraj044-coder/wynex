...
const CONTENT: Record<string, { title: string; updated: string; intro: string; sections: Section[] }> = {
  privacy: {
    ...
    sections: [
      ...
      { heading: 'Your rights', body: 'You may request access to, correction of, or deletion of your personal data at any time by emailing wynextechnologiespatna@gmail.com.' },
    ],
  },
  terms: {
      ...
      <div className="pt-36">
        <div className="container-x max-w-3xl pb-24">
          ...
          <p className="mt-12 rounded-3xl border border-white/60 bg-white/70 p-6 text-sm text-ink-muted backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.04] dark:text-slate-400">
            Questions about this policy? Email us at <a href="mailto:wynextechnologiespatna@gmail.com" className="font-semibold text-brand-indigo">wynextechnologiespatna@gmail.com</a>.
          </p>
        </div>
      </div>
    </>
